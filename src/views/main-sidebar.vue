    ...
    <div class="site-sidebar__inner">
      ...
      >
        ...
        <!-- <el-submenu index="demo2"> -->
          ...
          <!-- <el-menu-item index="demo-ueditor" @click="$router.push({ name: 'cloud-distribution' })">
            <icon-svg name="editor" class="site-sidebar__menu-icon"></icon-svg>
            <span slot="title">云发单工位</span>
          </el-menu-item> -->
        <!-- </el-submenu> -->
        ...
        <!-- <el-submenu index="demo6">
          ...
          <!-- <el-menu-item index="demo-ueditor" @click="$router.push({ name: 'group-manage' })">
            <i class="el-icon-news"></i>
